...
>>>>>>> 5df11eeafe00f5996d4b03e9b84036796d9c7254
```{r,results='hide'}
...
df_graphique4 <- responses %>%
  ...
  select(
    pv_mean,
    birth_year,
    academic_lvl, # Essentiel pour ton graphique par classe !
    digital_games_usage_for_learning,
    digital_resources_usage_for_learning_at_school_by_day,
    digital_resources_usage_for_learning_on_weekends,
    digital_resources_usage_for_learning_outside_school_by_day
  ...
  # 2. On aligne l'échelle des jeux (de 1-5 vers 1-9) pour pouvoir comparer
  mutate(
    digital_games_usage_for_learning = 1 + (digital_games_usage_for_learning - 1) * (9 - 1) / (5 - 1)
  ) %>%
  
  # 3. On pivote les activités pour avoir nos belles colonnes "Type_Activite" et "Frequence"
  # On exclut bien pv_mean, birth_year et academic_lvl du pivotement avec le "-"
  pivot_longer(
