...
# Construction d'un indicateur de performance.
...
# Etude de la courbe en "U inversé" de l'effet de l'usage des technologies sur les performance.
...
ggplot(synthese_graphique, aes(x = Frequence, y = Note_Moyenne, color = Type_Activite, group = Type_Activite)) +
  ...
  labs(
    ...
    caption = "Figure 1 | Source : Données PISA | Note : L'usage des jeux est distingué par un trait discontinu."
  ) +
...
ggplot(synthese_graphique, aes(x = Frequence, y = Note_Moyenne, color = Activity_Label, group = Activity_Label)) +
  ...
  labs(
    ...
    y = "Score Moyen PISA",
    color = "Type d'activité numérique",
    caption = "Figure 2 | Source : Données PISA | Note : L'usage des jeux est distingué par un trait discontinu."
  ) +
...
# Etude de l'utilisation de ressources numériques pour le loisir
