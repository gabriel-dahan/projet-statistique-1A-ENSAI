...
Nouvelles variables étudiées :

-   CNT, CNTRYID : Le pays (variable de contrôle), ainsi que le nombre de réponses par pays (intervalle de confiance, stat inférentielle);
-   ST003D03T : Age : permet de savoir si l'utilisation de jeux éducatifs impacte les performances en fonction du niveau scolaire - effet de seuil possible avec l'âge
...
-   Performances :
    ...
    -   Resources digitales : ST326Q01JA, ST322Q04JA
