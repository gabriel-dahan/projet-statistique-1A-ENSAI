...
Concernant le traitement des non-réponses, nous avons fait le choix d'exclure les observations manquantes lors des modélisations et analyses multivariées. Cela garantit que nos comparaisons reposent systématiquement sur des profils d'élèves complets vis-à-vis des variables étudiées.
