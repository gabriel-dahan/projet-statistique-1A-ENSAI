...
Cette segmentation de la population, issue de l'application de l'algorithme des K-means sur les coordonnées factorielles de l'ACM, permet d'identifier trois profils d'élèves aux trajectoires académiques contrastées.
...
fviz_mca_ind(res.mca, label = "none", habillage = data_base$Cluster, 
             palette = "jco", addEllipses = TRUE, title = "Classification par méthode K-means (3 groupes)")
```
